<template>
    <div class="wholeContent">
        ...
        <div class="impressum">
            ...
            <h3>Datenschutzerklärung (allgemein)</h3>
            <P>
            ...
            <p>
                ...
                installieren: <a target="_blank" href="http://tools.google.com/dlpage/gaoptout?hl=de">http://tools.google.com/dlpage/gaoptout?hl=de</a>.
            ...
            <p>
                Diese Website benutzt Google Adsense, einen Werbeanzeigendienst der Google Inc. ("Google"), 1600 Amphitheatre Parkway, 
                Mountain View, CA 94043, USA. Google Adsense verwendet sog. "Cookies" (Textdateien), die auf Ihrem Computer gespeichert 
                werden und die eine Analyse der Benutzung der Website durch Sie ermöglichen. Für die Auswertung verwendet 
                Google Adsense zusätzlich sog. "Web Beacons" (kleine unsichtbare Grafiken), welche z. B. Informationen wie den 
                Besucherverkehr auf der Seite erzeugen. Diese gesammelten Informationen (einschließlich Ihrer IP-Adresse) werden in 
                der Regel an einen Server von Google in den USA übertragen und dort gespeichert. Die Informationen verwendet Google, 
                um Ihre Nutzung der Website im Hinblick auf die Werbeanzeigen zu analysieren und so Auswertungen über die 
                Websiteaktivitäten und Werbeanzeigen für die Betreiber der Website vornehmen zu können sowie weitere 
                Dienstleistungen in Bezug auf die Websitenutzung und Internetnutzung erbringen zu können. Die von Google gesammelten 
                Informationen können an Dritte, durch Vertrag oder durch gesetzliche Vorschriften, von Google weitergegeben werden. 
                Google wird Ihre IP-Adresse nicht mit anderen von Ihnen gespeicherten Daten verknüpfen.
            </p>
            <p>
                Sie können die Speicherung der Cookies und die Anzeige der Web Beacons durch eine entsprechende Einstellung Ihrer 
