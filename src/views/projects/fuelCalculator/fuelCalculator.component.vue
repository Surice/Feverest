            ...
            <div class="input">
                <div class="div-headline">
                    ...
                    <div v-if="endurance==true" class="inputChangeBTN-div input-content-div">
                        <button class="inputChangeBTN" v-on:click="endurance=false" style="border-right: 1px solid black">Sprint</button>
                        <button class="inputChangeBTN aktivBTN" v-on:click="endurance=true">Endurance</button>
                    </div>
                    <div v-if="endurance==false" class="inputChangeBTN-div input-content-div">
                        <button class="inputChangeBTN aktivBTN" v-on:click="endurance=false" style="border-right: 1px solid black">Sprint</button>
                        <button class="inputChangeBTN" v-on:click="endurance=true">Endurance</button>
                    </div>
                </div>
                <div class="input-content">
                    <div class="raceDistance input-div">
                        <p class="input-headline">Race Distance:</p>
                            <div v-if="endurance==false" class="sprint-BTN-div input-content-div">
                                <button v-on:click="changeVar('20')" id="20" class="distance-BTN aktiv">20 min</button><p>|</p>
                                <button v-on:click="changeVar('30')" id="30" class="distance-BTN">30 min</button><p>|</p>
                                <button v-on:click="changeVar('45')" id="45" class="distance-BTN">45 min</button><p>|</p>
                                <button v-on:click="changeVar('60')" id="60" class="distance-BTN">60 min</button>
                            </div>
                    ...
                    <div class="lapTimes input-div">
                        ...
                        <div class="input-content-div">
                            <input type="number" id="laptimeMIN" min="0" v-model="input.laptime[0]" placeholder="MIN">   
                            <p>:</p>
                            <input type="number" id="laptimeSEC" min="0" max="59" v-model="input.laptime[1]" placeholder="SEC">
                        </div>
                    </div>
                    <div class="fuelCon input-div">
                        <p class="input-headline">Fuel Consumption:</p>
                        <div class="fuel-div">
                            <input type="number" id="FuelConsumption" min="0" v-model="input.fuelcon">
                            <p>Liters</p>
                        </div>
                    </div>
                    <div v-if="endurance==true" class=" input-div">
                        <p class="input-headline">Fueltank:</p>
                        <div class="fuel-div">
                            <input type="number" id= "Fueltank" min="0" v-model="input.fueltank">
                            <p>Liters</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="fuelBoxOutput-div">
                        <div class="fuelOutput-div">
                            ...
                            <div class="fuelOutput output-div">
                                <p id= 'ResultFuelCon' class="outputLine"> <b>{{ output.fuel }}</b></p>
                                <p>Liters</p>
                            </div>
                        </div>    
                        <div v-if="endurance==true" class="boxOutput-div">
                            ...
                            <div class="output-div">
                                <p id= 'ResultBoxenstops'> <b>{{ output.boxenstops }}</b> </p>     
                                <p>pit stops</p>
                            </div>
                        </div>    
                    </div>    
