<template>
  <div class="freeGames">
    ...
    <br><br>
    <router-link to="/newsletter/subscribe" tag="button"
        >Signup to the newsletter</router-link>
    </div>
...
<script src="./freeGames.component.js"></script>
<style scoped src="./freeGames.component.css"></style>